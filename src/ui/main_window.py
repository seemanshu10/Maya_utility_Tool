...
from src.ui import constraint_tab as constraint_tab_module
from src.ui import connection_tab as connection_tab_module
...
class RiggingUtilityTool(QMainWindow):
    ...
    def main_ui(self):
        ...
        source_column_layout.addWidget(self.source_obj_list)
        ...
        target_column_layout.addWidget(self.target_obj_list)
        ...
        self.constraint_tab_module = importlib.reload(constraint_tab_module)
        # print(self.constraint_tab_module )
        self.connection_tab_module = importlib.reload(connection_tab_module)
        self.ConstraintUI = self.constraint_tab_module.ConstraintUI
        self.ConnectionUI = self.connection_tab_module.ConnectionUI
        self.first_tab = self.ConstraintUI(self)
        self.second_tab = self.ConnectionUI(self)
